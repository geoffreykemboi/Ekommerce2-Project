...
// Assuming the hook is named useCreateProductMutation as in your code
import { useCreateProductMutation } from "../../redux/api/productsApi";
import { PRODUCT_CATEGORIES } from "../../constants/constants";

// Renamed component to NewProduct for consistency
const NewProduct = () => {
  ...
  const onChange = (e) => {
    // CORRECTED: This now correctly updates the local state
    setProduct({ ...product, [e.target.name]: e.target.value });
  };

  const submitHandler = (e) => {
    e.preventDefault();
    // The product object is sent to the mutation hook on submit
